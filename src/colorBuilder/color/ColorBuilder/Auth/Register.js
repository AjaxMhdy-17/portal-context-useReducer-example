...
import {handleSignIn} from '../../redux/actions/userActions'
    ...
    return (
        <div>
            <div className="form__full">
                <h3>Register Here</h3>
                {props.user.message?<p>{props.user.message}</p> : null}
...
export default connect(mapStateToProps , {handleSignIn : handleSignIn})(Register)
